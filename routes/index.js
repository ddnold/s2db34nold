...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Farmhands App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Farmhands App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Farmhands App Login', user : req.user }); 
}); 
